...
public class MealServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null || action.isEmpty()) {
            ...
            LocalDate startDate = strToDate(request.getParameter("startDate"));
            LocalDate endDate = strToDate(request.getParameter("endDate"));
            LocalTime startTime = strToTime(request.getParameter("startTime"));
            LocalTime endTime = strToTime(request.getParameter("endTime"));
